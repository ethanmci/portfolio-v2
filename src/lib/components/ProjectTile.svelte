...
<button class="h-auto flex group lg:col-span-1 col-span-3 mx-auto" tabindex="0">
	<div
	...
	>
		<div class="relative">
			...
			<div class="absolute -bottom-4 flex w-full px-4 text-stone-50">
				<span class="flex-1">
					<h3 class="text-2xl font-deco font-bold underline w-max p-2 bg-stone-700 rounded-sm shadow-sm">
						{title}
					</h3>
				</span>
				<p class="text-right font-deco text-2xl my-auto w-max p-2 bg-stone-700 rounded-sm shadow-sm">
					{year}
				</p>
			</div>
		</div>
